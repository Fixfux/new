...
jaka = ["ube7e5b15dbea0cc92f2067c04d25b1fc"]
        ...
        data = {
            ...
            "contents": {
             ...
             "hero": {
               ...
               "action": {
                 "type": "uri",
                 "uri": "https://line.me/ti/p/~boonmee502"
                 }
               },
                   "type": "bubble",
                   "body": {
      ...
      "contents": [{
          ...
          "contents": [{
              ...
              "action": {
                  "type": "uri",
                  "label": "OFFICIAL",
                  "uri": "https://line.me/ti/p/F_IZoWM8Jt"
              }
          }, {
              "flex": 3,
              "type": "button",
              ...
              "action": {
                  "type": "uri",
                  "label": "CREATOR",
                  "uri": "http://line.me/ti/p/~boonmee502"
              }
          }]
      }]
  }
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in jaka:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                #cl.sendText("ube7e5b15dbea0cc92f2067c04d25b1fc", '.')
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                            ...
                            if msg._from in admin or msg._from in owner:
                               try:cl.inviteIntoGroup(to, ["ube7e5b15dbea0cc92f2067c04d25b1fc"]);has = "OK"
                               except:has = "NOT"
                               try:cl.kickoutFromGroup(to, ["ube7e5b15dbea0cc92f2067c04d25b1fc"]);has1 = "OK"
                               except:has1 = "NOT"
